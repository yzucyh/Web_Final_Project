...
$(document).ready(function(){
  ...
  imgMain = new Image();
  imgMain.src = "JavaScript_L5_RPG_OK/images/spriteSheet.png";
  currentImgMainX = 0;
  currentImgMainY = 0;
  ...
  imgMountain.src = "JavaScript_L5_RPG_OK/images/material.png";
  imgEnemy = new Image();
  imgEnemy.src = "JavaScript_L5_RPG_OK/images/Enemy.png";
...
function jump(){
    ...
    cnt++;
    document.getElementById("count").innerHTML = parseInt(cnt/2);
}

var whenDead = setInterval(function(){
    var cTop = parseInt(window.getComputedStyle(character).getPropertyValue("top"));
    var pointLeft = parseInt(window.getComputedStyle(point).getPropertyValue("left"));
    if(pointLeft<10 && pointLeft>0 && cTop>=130)
    {
        point.style.animation = "none";
        point.style.display = "none";
        alert("You lose， Press F5 to restart the game")
    }
},10);
